 ...
 */
import type { ApiV1ApprovalActionRequestApprovalAction } from './apiV1ApprovalActionRequestApprovalAction';

export interface ApiV1ApprovalActionRequest {
  /**
   * 事業所ID
   * @minimum 1
   * @maximum 2147483647
  ...
  approval_action: ApiV1ApprovalActionRequestApprovalAction;
  /**
