 ...
 */
export type ApiV1ApprovalActionRequestApprovalAction = typeof ApiV1ApprovalActionRequestApprovalAction[keyof typeof ApiV1ApprovalActionRequestApprovalAction];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1ApprovalActionRequestApprovalAction = {
  approve: 'approve',
  cancel: 'cancel',
  feedback: 'feedback',
