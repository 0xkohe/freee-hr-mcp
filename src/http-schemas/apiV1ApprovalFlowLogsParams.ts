 ...
 */
import type { ApiV1ApprovalFlowLogsParamsAction } from './apiV1ApprovalFlowLogsParamsAction';

export interface ApiV1ApprovalFlowLogsParams {
  /**
   * 申請操作をしたユーザーのユーザーID
   * @minimum 0
   * @maximum 2147483647
  ...
  action?: ApiV1ApprovalFlowLogsParamsAction;
  /** 申請操作をした日付時間 */
  update_at?: string;
}
