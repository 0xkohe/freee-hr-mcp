 ...
 */
export type ApiV1ApprovalFlowLogsParamsAction = typeof ApiV1ApprovalFlowLogsParamsAction[keyof typeof ApiV1ApprovalFlowLogsParamsAction];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1ApprovalFlowLogsParamsAction = {
  apply: 'apply',
  approve: 'approve',
  cancel: 'cancel',
  feedback: 'feedback',
