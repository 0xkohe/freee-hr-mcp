 ...
 */
import type { ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem } from './apiV1ApprovalFlowRouteIndexResponseParamsUsagesItem';

export interface ApiV1ApprovalFlowRouteIndexResponseParams {
  /**
   * 申請経路ID
   * @minimum 1
   * @maximum 2147483647
...
- PersonalDataWorkflow - 身上変更申請 */
  usages?: ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem[];
}
