...
export type ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem = typeof ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem[keyof typeof ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1ApprovalFlowRouteIndexResponseParamsUsagesItem = {
  AttendanceWorkflow: 'AttendanceWorkflow',
  PersonalDataWorkflow: 'PersonalDataWorkflow',
} as const;
