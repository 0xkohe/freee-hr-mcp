 ...
 */
import type { ApiV1ApprovalFlowRouteResponseParamsUsagesItem } from './apiV1ApprovalFlowRouteResponseParamsUsagesItem';
import type { ApiV1FlowRouteStepSrializer } from './apiV1FlowRouteStepSrializer';

export interface ApiV1ApprovalFlowRouteResponseParams {
  /**
   * 申請経路ID
   * @minimum 1
   * @maximum 2147483647
...
- PersonalDataWorkflow - 身上変更申請 */
  usages?: ApiV1ApprovalFlowRouteResponseParamsUsagesItem[];
