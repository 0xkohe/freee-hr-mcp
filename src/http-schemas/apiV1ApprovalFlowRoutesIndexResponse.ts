 ...
 */
import type { ApiV1ApprovalFlowRouteIndexResponseParams } from './apiV1ApprovalFlowRouteIndexResponseParams';

export interface ApiV1ApprovalFlowRoutesIndexResponse {
  approval_flow_routes: ApiV1ApprovalFlowRouteIndexResponseParams[];
}
