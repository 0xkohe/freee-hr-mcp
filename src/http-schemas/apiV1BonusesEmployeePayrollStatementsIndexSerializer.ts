 ...
 */
import type { ApiV1BonusesEmployeePayrollStatementSerializer } from './apiV1BonusesEmployeePayrollStatementSerializer';

export interface ApiV1BonusesEmployeePayrollStatementsIndexSerializer {
  employee_payroll_statements?: ApiV1BonusesEmployeePayrollStatementSerializer[];
  /** 合計件数 */
  total_count?: number;
}
