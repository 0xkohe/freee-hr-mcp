 ...
 */
export type ApiV1EmployeeCreateRequestSerializerPayCalcType = typeof ApiV1EmployeeCreateRequestSerializerPayCalcType[keyof typeof ApiV1EmployeeCreateRequestSerializerPayCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeCreateRequestSerializerPayCalcType = {
  monthly: 'monthly',
  daily: 'daily',
  hourly: 'hourly',
} as const;
