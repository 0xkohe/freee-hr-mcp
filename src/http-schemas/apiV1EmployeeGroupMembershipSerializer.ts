 ...
 */
import type { ApiV1EmployeeGroupMembershipSerializerGender } from './apiV1EmployeeGroupMembershipSerializerGender';
import type { ApiV1GroupMembershipSerializer } from './apiV1GroupMembershipSerializer';
...
export interface ApiV1EmployeeGroupMembershipSerializer {
  ...
  gender?: ApiV1EmployeeGroupMembershipSerializerGender;
  /** 給与計算対象従業員の場合trueを返します */
  payroll_calculation?: boolean;
  group_memberships?: ApiV1GroupMembershipSerializer[];
}
