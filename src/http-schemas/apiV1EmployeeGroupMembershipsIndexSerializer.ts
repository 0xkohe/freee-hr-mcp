 ...
 */
import type { ApiV1EmployeeGroupMembershipSerializer } from './apiV1EmployeeGroupMembershipSerializer';

export interface ApiV1EmployeeGroupMembershipsIndexSerializer {
  employee_group_memberships?: ApiV1EmployeeGroupMembershipSerializer[];
  /** 合計件数 */
  total_count?: number;
}
