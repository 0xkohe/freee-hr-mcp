 ...
 */
import type { ApiV1EmployeeProfileCustomFieldSerializerFieldType } from './apiV1EmployeeProfileCustomFieldSerializerFieldType';

export interface ApiV1EmployeeProfileCustomFieldSerializer {
  /** カスタム項目ID */
  id?: number;
  /** 項目タイプ file: ファイル, text: テキスト, number: 数値, date: 日付, selector: セレクター, time: 時間 */
  field_type?: ApiV1EmployeeProfileCustomFieldSerializerFieldType;
  /** 項目名 */
  name?: string;
  /**
