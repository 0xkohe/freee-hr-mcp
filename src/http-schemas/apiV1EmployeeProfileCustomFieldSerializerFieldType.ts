 ...
 */
export type ApiV1EmployeeProfileCustomFieldSerializerFieldType = typeof ApiV1EmployeeProfileCustomFieldSerializerFieldType[keyof typeof ApiV1EmployeeProfileCustomFieldSerializerFieldType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeProfileCustomFieldSerializerFieldType = {
  file: 'file',
  text: 'text',
  number: 'number',
  date: 'date',
