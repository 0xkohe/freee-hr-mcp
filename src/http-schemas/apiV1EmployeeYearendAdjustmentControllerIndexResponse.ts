 ...
 */
import type { ApiV1EmployeeYearendAdjustmentParams } from './apiV1EmployeeYearendAdjustmentParams';

export interface ApiV1EmployeeYearendAdjustmentControllerIndexResponse {
  employees?: ApiV1EmployeeYearendAdjustmentParams[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
