 ...
 */
import type { ApiV1EmployeeYearendAdjustmentEmployeeSerializer } from './apiV1EmployeeYearendAdjustmentEmployeeSerializer';
import type { ApiV1EmployeeYearendAdjustmentDependentSerializer } from './apiV1EmployeeYearendAdjustmentDependentSerializer';
import type { ApiV1EmployeeYearendAdjustmentInsuranceSerializer } from './apiV1EmployeeYearendAdjustmentInsuranceSerializer';
import type { ApiV1EmployeeYearendAdjustmentHousingLoanSerializer } from './apiV1EmployeeYearendAdjustmentHousingLoanSerializer';
import type { ApiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer } from './apiV1EmployeeYearendAdjustmentPayrollAndBonusSerializer';
import type { ApiV1EmployeeYearendAdjustmentPreviousJobSerializer } from './apiV1EmployeeYearendAdjustmentPreviousJobSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerShowResponse {
  /** 本人情報 */
  employee?: ApiV1EmployeeYearendAdjustmentEmployeeSerializer;
  /** 家族情報(年末調整対象外の場合は取得できません。) */
  dependents?: ApiV1EmployeeYearendAdjustmentDependentSerializer[];
  /** 保険料情報(年末調整対象外の場合は取得できません。) */
  insurances?: ApiV1EmployeeYearendAdjustmentInsuranceSerializer[];
  /**
  ...
  housing_loans?: ApiV1EmployeeYearendAdjustmentHousingLoanSerializer[];
  /** 給与・賞与 */
