 ...
 */
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdateDependentsBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
  ...
  company_id: number;
  /** 家族情報 */
  dependents: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer[];
}
