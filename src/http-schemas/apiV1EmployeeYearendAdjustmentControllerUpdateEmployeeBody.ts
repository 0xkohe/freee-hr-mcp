 ...
 */
import type { ApiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentEmployeeUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdateEmployeeBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
