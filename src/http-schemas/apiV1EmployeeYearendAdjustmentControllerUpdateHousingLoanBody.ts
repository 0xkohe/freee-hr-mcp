 ...
 */
import type { ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdateHousingLoanBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
