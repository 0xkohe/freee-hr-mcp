 ...
 */
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdateInsuranceBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
