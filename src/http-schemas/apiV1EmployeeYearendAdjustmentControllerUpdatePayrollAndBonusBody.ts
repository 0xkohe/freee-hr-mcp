 ...
 */
import type { ApiV1EmployeeYearendAdjustmentPayrollAndBonusUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentPayrollAndBonusUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdatePayrollAndBonusBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
