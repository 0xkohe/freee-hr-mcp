 ...
 */
import type { ApiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer } from './apiV1EmployeeYearendAdjustmentPreviousJobUpdateRequestSerializer';

export interface ApiV1EmployeeYearendAdjustmentControllerUpdatePreviousJobBody {
  /**
   * 更新対象事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
