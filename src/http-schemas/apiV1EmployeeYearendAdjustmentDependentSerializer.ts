 ...
 */
import type { ApiV1EmployeeYearendAdjustmentDependentSerializerRelationship } from './apiV1EmployeeYearendAdjustmentDependentSerializerRelationship';
import type { ApiV1EmployeeYearendAdjustmentDependentSerializerSocialInsuranceAndTaxDependent } from './apiV1EmployeeYearendAdjustmentDependentSerializerSocialInsuranceAndTaxDependent';
import type { ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType } from './apiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType';
import type { ApiV1EmployeeYearendAdjustmentDependentSerializerResidenceType } from './apiV1EmployeeYearendAdjustmentDependentSerializerResidenceType';
import type { ApiV1EmployeeYearendAdjustmentDependentSerializerNonResidentDependentsReason } from './apiV1EmployeeYearendAdjustmentDependentSerializerNonResidentDependentsReason';

export interface ApiV1EmployeeYearendAdjustmentDependentSerializer {
  /** 家族情報ID */
  id?: number;
  /**
   * 姓 null不可
  ...
  relationship?: ApiV1EmployeeYearendAdjustmentDependentSerializerRelationship;
  ...
  social_insurance_and_tax_dependent?: ApiV1EmployeeYearendAdjustmentDependentSerializerSocialInsuranceAndTaxDependent;
  /**
  ...
  disability_type?: ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType;
  /** 同居・別居 null不可 live_in: 同居, resident: 別居(国内), non_resident: 別居(国外) */
  residence_type?: ApiV1EmployeeYearendAdjustmentDependentSerializerResidenceType;
  /**
  ...
  non_resident_dependents_reason?: ApiV1EmployeeYearendAdjustmentDependentSerializerNonResidentDependentsReason;
  /** 住民税のみの控除対象かどうか */
