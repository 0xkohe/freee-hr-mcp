 ...
 */
export type ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType = typeof ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType[keyof typeof ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentDependentSerializerDisabilityType = {
  na: 'na',
  general: 'general',
  heavy: 'heavy',
} as const;
