 ...
 */
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerRelationship } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerRelationship';
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent';
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerDisabilityType } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerDisabilityType';
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerResidenceType } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerResidenceType';
import type { ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason } from './apiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason';

export interface ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializer {
  /**
  ...
  relationship: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerRelationship;
  /**
  ...
  social_insurance_and_tax_dependent: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent;
  /**
  ...
  disability_type: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerDisabilityType;
  /** 同居・別居 null不可 live_in: 同居, resident: 別居(国内), non_resident: 別居(国外) */
  residence_type: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerResidenceType;
  /**
  ...
  non_resident_dependents_reason?: ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason;
  /** 住民税のみの控除対象かどうか */
