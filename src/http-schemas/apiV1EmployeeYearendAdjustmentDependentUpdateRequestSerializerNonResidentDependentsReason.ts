 ...
 */
export type ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason = typeof ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason[keyof typeof ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerNonResidentDependentsReason = {
  none: 'none',
  over_16_to_under_30_or_over_70: 'over_16_to_under_30_or_over_70',
  study_abroad: 'study_abroad',
  handicapped: 'handicapped',
  over_38_man: 'over_38_man',
} as const;
