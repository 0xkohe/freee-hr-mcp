 ...
 */
export type ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent = typeof ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent[keyof typeof ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentDependentUpdateRequestSerializerSocialInsuranceAndTaxDependent = {
  social_insurance_and_tax: 'social_insurance_and_tax',
  tax_only: 'tax_only',
  social_insurance_only: 'social_insurance_only',
