 ...
 */
import type { ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType } from './apiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType';
import type { ApiV1EmployeeYearendAdjustmentEmployeeSerializerWidowType } from './apiV1EmployeeYearendAdjustmentEmployeeSerializerWidowType';
import type { ApiV1EmployeeYearendAdjustmentEmployeeSerializerDisabilityType } from './apiV1EmployeeYearendAdjustmentEmployeeSerializerDisabilityType';
import type { ApiV1EmployeeYearendAdjustmentEmployeeSerializerHouseholder } from './apiV1EmployeeYearendAdjustmentEmployeeSerializerHouseholder';

export interface ApiV1EmployeeYearendAdjustmentEmployeeSerializer {
  /** 従業員ID */
  employee_id?: number;
  /**
   * 従業員番号<br>
従業員を判別しやすいよう管理することができます。（例: 1人目の正社員を A-001 と入力）
  ...
  payer_type?: ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType;
  /** 寡夫／寡婦かどうか null不可 na: 空白, widow: 寡婦, one_parent: ひとり親 */
  widow_type?: ApiV1EmployeeYearendAdjustmentEmployeeSerializerWidowType;
  /** 障害者かどうか na: 空白, general: 障害者, heavy: 特別障害者 */
  disability_type?: ApiV1EmployeeYearendAdjustmentEmployeeSerializerDisabilityType;
  /** 配偶者の有無 */
  married?: boolean;
  /** 勤労学生かどうか */
  ...
  householder?: ApiV1EmployeeYearendAdjustmentEmployeeSerializerHouseholder;
  /**
   * 世帯主の名前
   * @maxLength 255
   */
