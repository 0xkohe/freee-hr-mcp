 ...
 */
export type ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType = typeof ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType[keyof typeof ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentEmployeeSerializerPayerType = {
  kou: 'kou',
  otsu: 'otsu',
  hei: 'hei',
} as const;
