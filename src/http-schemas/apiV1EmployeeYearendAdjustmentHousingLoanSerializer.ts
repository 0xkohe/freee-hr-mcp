 ...
 */
import type { ApiV1EmployeeYearendAdjustmentHousingLoanSerializerCategory } from './apiV1EmployeeYearendAdjustmentHousingLoanSerializerCategory';
import type { ApiV1EmployeeYearendAdjustmentHousingLoanSerializerSpecificCaseType } from './apiV1EmployeeYearendAdjustmentHousingLoanSerializerSpecificCaseType';

export interface ApiV1EmployeeYearendAdjustmentHousingLoanSerializer {
  /**
   * 住宅ローンID
   * @minimum 1
   * @maximum 2147483647
  ...
  category?: ApiV1EmployeeYearendAdjustmentHousingLoanSerializerCategory;
  ...
  specific_case_type?: ApiV1EmployeeYearendAdjustmentHousingLoanSerializerSpecificCaseType;
}
