 ...
 */
export type ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializerSpecificCaseType = typeof ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializerSpecificCaseType[keyof typeof ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializerSpecificCaseType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentHousingLoanUpdateRequestSerializerSpecificCaseType = {
  not_qualified: 'not_qualified',
  specified: 'specified',
  special_specified_or_special_exception: 'special_specified_or_special_exception',
  exception_special_exception: 'exception_special_exception',
  special_residential_house: 'special_residential_house',
} as const;
