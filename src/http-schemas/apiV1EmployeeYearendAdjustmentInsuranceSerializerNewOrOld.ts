 ...
 */
export type ApiV1EmployeeYearendAdjustmentInsuranceSerializerNewOrOld = typeof ApiV1EmployeeYearendAdjustmentInsuranceSerializerNewOrOld[keyof typeof ApiV1EmployeeYearendAdjustmentInsuranceSerializerNewOrOld];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentInsuranceSerializerNewOrOld = {
  new: 'new',
  old: 'old',
  none: 'none',
} as const;
