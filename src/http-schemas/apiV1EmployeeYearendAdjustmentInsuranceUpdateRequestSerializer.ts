 ...
 */
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerType } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerType';
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerCategory } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerCategory';
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerNewOrOld } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerNewOrOld';
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerPeriod } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerPeriod';
import type { ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship } from './apiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship';

export interface ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializer {
  ...
  type: ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerType;
  /** 区分<br>
...
　dsma: 心身障害者扶養共済制度に関する契約の掛金<br> */
  category: ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerCategory;
  /** 新旧区分<br>
区分が生命保険または個人年金保険の時のみ、新制度なら new を、旧制度なら old を指定します。<br>
上記以外の保険では none を指定してください。 */
  new_or_old: ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerNewOrOld;
  /**
   * 保険会社等の名称<br>
...
上記以外の保険では入力した値は反映されません。
   * @nullable
   */
  period?: ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerPeriod;
  /**
   * 保険等の契約者 姓<br>
保険の種類にて、生命保険・介護医療保険・個人年金保険または地震保険・旧長期損害保険を選択している時のみ、入力した値が反映されます。<br>
上記以外の保険では入力した値は反映されません。
...
上記以外の保険では入力した値は反映されません。
   * @nullable
   */
  recipient_relationship?: ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship;
  /**
