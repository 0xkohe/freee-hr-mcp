 ...
 * @nullable
 */
export type ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship = typeof ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship[keyof typeof ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentInsuranceUpdateRequestSerializerRecipientRelationship = {
  myself: 'myself',
  husband: 'husband',
  wife: 'wife',
  father: 'father',
  ...
  grandfather_in_law: 'grandfather_in_law',
  grandmother_in_law: 'grandmother_in_law',
  other: 'other',
  '': '',
} as const;
