 ...
 */
import type { ApiV1EmployeeYearendAdjustmentParamsStatus } from './apiV1EmployeeYearendAdjustmentParamsStatus';

export interface ApiV1EmployeeYearendAdjustmentParams {
  /** 従業員ID */
  employee_id?: number;
  /**
   * 従業員番号
...
- submitted - 従業員入力済
- fixed - 確定 */
  status?: ApiV1EmployeeYearendAdjustmentParamsStatus;
}
