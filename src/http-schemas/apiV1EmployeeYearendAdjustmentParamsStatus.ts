...
- fixed - 確定
 */
export type ApiV1EmployeeYearendAdjustmentParamsStatus = typeof ApiV1EmployeeYearendAdjustmentParamsStatus[keyof typeof ApiV1EmployeeYearendAdjustmentParamsStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeeYearendAdjustmentParamsStatus = {
  initialized: 'initialized',
  in_employee_progress: 'in_employee_progress',
  submitted: 'submitted',
  fixed: 'fixed',
} as const;
