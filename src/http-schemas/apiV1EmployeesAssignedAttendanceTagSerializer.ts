 ...
 */
import type { ApiV1EmployeesAssignedAttendanceTagSerializerAttendanceTag } from './apiV1EmployeesAssignedAttendanceTagSerializerAttendanceTag';

export interface ApiV1EmployeesAssignedAttendanceTagSerializer {
  attendance_tag: ApiV1EmployeesAssignedAttendanceTagSerializerAttendanceTag;
  /**
   * 勤怠タグ回数
   * @minimum 0
   * @maximum 999
