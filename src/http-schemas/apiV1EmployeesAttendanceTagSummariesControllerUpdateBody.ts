 ...
 */
import type { ApiV1EmployeesAttendanceTagSummaryUpdateRequestSerializer } from './apiV1EmployeesAttendanceTagSummaryUpdateRequestSerializer';

export interface ApiV1EmployeesAttendanceTagSummariesControllerUpdateBody {
  /**
   * 事業所ID
   * @minimum 1
   * @maximum 2147483647
  ...
  company_id: number;
  /** 更新対象の勤怠タグサマリのリスト */
  employee_attendance_tag_summaries: ApiV1EmployeesAttendanceTagSummaryUpdateRequestSerializer[];
}
