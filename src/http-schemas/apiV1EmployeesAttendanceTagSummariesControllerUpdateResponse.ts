 ...
 */
import type { ApiV1EmployeesAttendanceTagSummary } from './apiV1EmployeesAttendanceTagSummary';

export interface ApiV1EmployeesAttendanceTagSummariesControllerUpdateResponse {
  employee_attendance_tag_summaries?: ApiV1EmployeesAttendanceTagSummary[];
}
