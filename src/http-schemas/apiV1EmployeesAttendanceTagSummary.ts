 ...
 */
import type { ApiV1EmployeesAttendanceTagSummaryAttendanceTag } from './apiV1EmployeesAttendanceTagSummaryAttendanceTag';

export interface ApiV1EmployeesAttendanceTagSummary {
  attendance_tag: ApiV1EmployeesAttendanceTagSummaryAttendanceTag;
  /**
   * 勤怠タグ回数
   * @minimum 0
   * @maximum 99999
