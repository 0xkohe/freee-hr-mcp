 ...
 */
import type { ApiV1EmployeesAttendanceTagSerializer } from './apiV1EmployeesAttendanceTagSerializer';

export interface ApiV1EmployeesAttendanceTagsControllerIndexResponse {
  employee_attendance_tags?: ApiV1EmployeesAttendanceTagSerializer[];
}
