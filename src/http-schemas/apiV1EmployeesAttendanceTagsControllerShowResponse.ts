 ...
 */
import type { ApiV1EmployeesAssignedAttendanceTagSerializer } from './apiV1EmployeesAssignedAttendanceTagSerializer';

export interface ApiV1EmployeesAttendanceTagsControllerShowResponse {
  employee_attendance_tags?: ApiV1EmployeesAssignedAttendanceTagSerializer[];
}
