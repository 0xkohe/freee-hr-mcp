 ...
 */
import type { ApiV1EmployeesAttendanceTagUpdateRequestSerializer } from './apiV1EmployeesAttendanceTagUpdateRequestSerializer';

export interface ApiV1EmployeesAttendanceTagsControllerUpdateBody {
  /**
   * 事業所ID
   * @minimum 1
   * @maximum 2147483647
  ...
  company_id: number;
  /** 更新対象の勤怠タグのリスト */
  employee_attendance_tags: ApiV1EmployeesAttendanceTagUpdateRequestSerializer[];
}
