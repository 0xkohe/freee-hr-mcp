 ...
 */
export type ApiV1EmployeesBankAccountRuleUpdateRequestSerializerAccountType = typeof ApiV1EmployeesBankAccountRuleUpdateRequestSerializerAccountType[keyof typeof ApiV1EmployeesBankAccountRuleUpdateRequestSerializerAccountType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesBankAccountRuleUpdateRequestSerializerAccountType = {
  ordinary: 'ordinary',
  current: 'current',
  saving: 'saving',
} as const;
