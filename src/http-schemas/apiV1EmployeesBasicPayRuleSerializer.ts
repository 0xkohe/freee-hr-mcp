 ...
 */
import type { ApiV1EmployeesBasicPayRuleSerializerPayCalcType } from './apiV1EmployeesBasicPayRuleSerializerPayCalcType';
...
export type ApiV1EmployeesBasicPayRuleSerializer = {
  ...
  pay_calc_type?: ApiV1EmployeesBasicPayRuleSerializerPayCalcType;
  /**
   * 基本給
   * @minimum 0
   * @maximum 99999999
