 ...
 */
export type ApiV1EmployeesBasicPayRuleSerializerPayCalcType = typeof ApiV1EmployeesBasicPayRuleSerializerPayCalcType[keyof typeof ApiV1EmployeesBasicPayRuleSerializerPayCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesBasicPayRuleSerializerPayCalcType = {
  monthly: 'monthly',
  daily: 'daily',
  hourly: 'hourly',
} as const;
