 ...
 */
import type { ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType } from './apiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType';

export interface ApiV1EmployeesBasicPayRuleUpdateRequestSerializer {
  /** 給与方式 null不可 monthly: 月給, daily: 日給, hourly: 時給 */
  pay_calc_type: ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType;
  /**
   * 基本給 null不可
   * @minimum 0
   * @maximum 99999999
