 ...
 */
export type ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType = typeof ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType[keyof typeof ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesBasicPayRuleUpdateRequestSerializerPayCalcType = {
  monthly: 'monthly',
  daily: 'daily',
  hourly: 'hourly',
} as const;
