 ...
 * @nullable
 */
export type ApiV1EmployeesDependentRuleUpdateRequestSerializerEmploymentInsuranceReceiveStatus = typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerEmploymentInsuranceReceiveStatus[keyof typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerEmploymentInsuranceReceiveStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesDependentRuleUpdateRequestSerializerEmploymentInsuranceReceiveStatus = {
  unselected: 'unselected',
  receiving_employment_insurance: 'receiving_employment_insurance',
  not_receiving_employment_insurance: 'not_receiving_employment_insurance',
  pending_employment_insurance: 'pending_employment_insurance',
} as const;
