 ...
 */
export type ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentAcquisitionReason = typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentAcquisitionReason[keyof typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentAcquisitionReason];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentAcquisitionReason = {
  '': '',
  start_working: 'start_working',
  marriage: 'marriage',
  turnover: 'turnover',
  decrease_in_income: 'decrease_in_income',
  other: 'other',
  birth: 'birth',
  live_in: 'live_in',
} as const;
