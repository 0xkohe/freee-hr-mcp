 ...
 */
export type ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentDisqualificationReason = typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentDisqualificationReason[keyof typeof ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentDisqualificationReason];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesDependentRuleUpdateRequestSerializerSocialInsuranceDependentDisqualificationReason = {
  '': '',
  death: 'death',
  divorce: 'divorce',
  start_working_or_increase_in_income: 'start_working_or_increase_in_income',
  reach_75_years_old: 'reach_75_years_old',
