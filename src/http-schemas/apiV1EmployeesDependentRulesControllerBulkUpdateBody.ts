 ...
 */
import type { ApiV1EmployeesDependentRuleUpdateRequestSerializer } from './apiV1EmployeesDependentRuleUpdateRequestSerializer';
...
翌月払いの従業員の2022/01の従業員情報を更新する場合は、year=2021,month=12を指定してください。<br>
  ...
  month: number;
  /** 家族情報ルール */
  employee_dependent_rules: ApiV1EmployeesDependentRuleUpdateRequestSerializer[];
}
