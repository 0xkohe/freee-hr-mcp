 ...
 * 賞与計算時の介護保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceBonusCalcType = typeof ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceBonusCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
