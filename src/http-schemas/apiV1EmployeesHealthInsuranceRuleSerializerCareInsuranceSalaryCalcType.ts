 ...
 * 給与計算時の介護保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceSalaryCalcType = typeof ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleSerializerCareInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
