 ...
 * 賞与計算時の健康保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceBonusCalcType = typeof ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceBonusCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
