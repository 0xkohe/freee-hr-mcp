 ...
 * 給与計算時の健康保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceSalaryCalcType = typeof ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleSerializerHealthInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
