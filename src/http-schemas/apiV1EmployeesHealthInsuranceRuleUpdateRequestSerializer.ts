 ...
 */
import type { ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType } from './apiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType';
import type { ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType } from './apiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType';
import type { ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType } from './apiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType';
import type { ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType } from './apiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType';

export interface ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializer {
  /** 健康保険に加入しているかどうか null不可 */
  entried?: boolean;
  /** 給与計算時の健康保険料の計算方法 */
  health_insurance_salary_calc_type?: ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType;
  /** 賞与計算時の健康保険料の計算方法 */
  health_insurance_bonus_calc_type?: ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType;
  /**
  ...
  /** 給与計算時の介護保険料の計算方法 */
  care_insurance_salary_calc_type?: ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType;
  /** 賞与計算時の介護保険料の計算方法 */
  care_insurance_bonus_calc_type?: ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType;
  /**
