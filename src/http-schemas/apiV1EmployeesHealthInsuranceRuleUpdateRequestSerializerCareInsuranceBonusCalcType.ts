 ...
 * 賞与計算時の介護保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType = typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
