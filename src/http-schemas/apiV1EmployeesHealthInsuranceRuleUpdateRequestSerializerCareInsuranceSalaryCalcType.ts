 ...
 * 給与計算時の介護保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType = typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerCareInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
