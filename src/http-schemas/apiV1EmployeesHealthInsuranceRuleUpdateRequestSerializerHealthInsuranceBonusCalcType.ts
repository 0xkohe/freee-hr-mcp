 ...
 * 賞与計算時の健康保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType = typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
