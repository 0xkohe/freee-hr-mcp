 ...
 * 給与計算時の健康保険料の計算方法
 */
export type ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType = typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesHealthInsuranceRuleUpdateRequestSerializerHealthInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
