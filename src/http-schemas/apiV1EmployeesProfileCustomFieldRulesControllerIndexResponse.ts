 ...
 */
import type { ApiV1ProfileCustomFieldGroupSerializer } from './apiV1ProfileCustomFieldGroupSerializer';

export interface ApiV1EmployeesProfileCustomFieldRulesControllerIndexResponse {
  profile_custom_field_groups?: ApiV1ProfileCustomFieldGroupSerializer[];
}
