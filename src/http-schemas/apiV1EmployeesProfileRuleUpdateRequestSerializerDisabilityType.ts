 ...
 */
export type ApiV1EmployeesProfileRuleUpdateRequestSerializerDisabilityType = typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerDisabilityType[keyof typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerDisabilityType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesProfileRuleUpdateRequestSerializerDisabilityType = {
  na: 'na',
  general: 'general',
  heavy: 'heavy',
} as const;
