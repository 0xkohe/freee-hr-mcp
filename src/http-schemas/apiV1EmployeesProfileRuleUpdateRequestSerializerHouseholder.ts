 ...
 */
export type ApiV1EmployeesProfileRuleUpdateRequestSerializerHouseholder = typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerHouseholder[keyof typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerHouseholder];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesProfileRuleUpdateRequestSerializerHouseholder = {
  myself: 'myself',
  husband: 'husband',
  wife: 'wife',
  father: 'father',
