 ...
 */
export type ApiV1EmployeesProfileRuleUpdateRequestSerializerWidowType = typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerWidowType[keyof typeof ApiV1EmployeesProfileRuleUpdateRequestSerializerWidowType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesProfileRuleUpdateRequestSerializerWidowType = {
  na: 'na',
  widower: 'widower',
  widow: 'widow',
  special_widow: 'special_widow',
