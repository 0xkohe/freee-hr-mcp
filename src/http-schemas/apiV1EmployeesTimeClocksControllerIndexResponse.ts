 ...
 */
import type { ApiV1EmployeesTimeClockSerializer } from './apiV1EmployeesTimeClockSerializer';

export type ApiV1EmployeesTimeClocksControllerIndexResponse = ApiV1EmployeesTimeClockSerializer[];
