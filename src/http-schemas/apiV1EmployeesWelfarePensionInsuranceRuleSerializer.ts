 ...
 */
import type { ApiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionBonusCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionBonusCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionSalaryCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionSalaryCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType';
...
export type ApiV1EmployeesWelfarePensionInsuranceRuleSerializer = {
  ...
  child_allowance_contribution_bonus_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionBonusCalcType;
  /** 給与計算時の子ども・子育て拠出金の計算方法 */
  child_allowance_contribution_salary_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleSerializerChildAllowanceContributionSalaryCalcType;
  /** 事業所ID */
  company_id?: number;
  /** 従業員ID */
  employee_id?: number;
  ...
  /** 賞与計算時の厚生年金保険料の計算方法 */
  welfare_pension_insurance_bonus_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType;
  /** 給与計算時の厚生年金保険料の計算方法 */
  welfare_pension_insurance_salary_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType;
} | null;
