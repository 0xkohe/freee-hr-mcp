 ...
 * 賞与計算時の厚生年金保険料の計算方法
 */
export type ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType = typeof ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType[keyof typeof ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
