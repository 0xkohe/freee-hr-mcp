 ...
 * 給与計算時の厚生年金保険料の計算方法
 */
export type ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType = typeof ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesWelfarePensionInsuranceRuleSerializerWelfarePensionInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
