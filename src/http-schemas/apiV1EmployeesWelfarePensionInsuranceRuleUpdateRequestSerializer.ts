 ...
 */
import type { ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionSalaryCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionSalaryCalcType';
import type { ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionBonusCalcType } from './apiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionBonusCalcType';

export interface ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializer {
  /** 厚生年金保険に加入しているかどうか null不可 */
  entried?: boolean;
  /** 給与計算時の厚生年金保険料の計算方法 */
  welfare_pension_insurance_salary_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType;
  /** 賞与計算時の厚生年金保険料の計算方法 */
  welfare_pension_insurance_bonus_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType;
  /**
  ...
  child_allowance_contribution_salary_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionSalaryCalcType;
  /** 賞与計算時の子ども・子育て拠出金の計算方法 */
  child_allowance_contribution_bonus_calc_type?: ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerChildAllowanceContributionBonusCalcType;
  /**
