 ...
 * 賞与計算時の厚生年金保険料の計算方法
 */
export type ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType = typeof ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType[keyof typeof ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceBonusCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
