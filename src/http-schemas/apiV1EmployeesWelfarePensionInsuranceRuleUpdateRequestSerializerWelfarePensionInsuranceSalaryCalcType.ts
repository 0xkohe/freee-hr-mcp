 ...
 * 給与計算時の厚生年金保険料の計算方法
 */
export type ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType = typeof ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType[keyof typeof ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesWelfarePensionInsuranceRuleUpdateRequestSerializerWelfarePensionInsuranceSalaryCalcType = {
  auto: 'auto',
  manual: 'manual',
} as const;
