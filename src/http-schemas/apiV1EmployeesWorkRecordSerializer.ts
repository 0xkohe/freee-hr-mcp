...
import type { ApiV1EmployeesWorkRecordSerializerDayPattern } from './apiV1EmployeesWorkRecordSerializerDayPattern';
import type { ApiV1EmployeesWorkRecordSerializerSchedulePattern } from './apiV1EmployeesWorkRecordSerializerSchedulePattern';
import type { ApiV1EmployeesWorkRecordSerializerPaidHolidaysItem } from './apiV1EmployeesWorkRecordSerializerPaidHolidaysItem';
...
- legal_holiday: 法定休日 */
  day_pattern?: ApiV1EmployeesWorkRecordSerializerDayPattern;
  /** スケジュールパターン
...
- special_holiday: 特別休暇 */
  schedule_pattern?: ApiV1EmployeesWorkRecordSerializerSchedulePattern;
  /** 早退分の時間（分単位） */
  ...
  note?: string;
  /** 年次有給休暇の実績 */
  paid_holidays?: ApiV1EmployeesWorkRecordSerializerPaidHolidaysItem[];
