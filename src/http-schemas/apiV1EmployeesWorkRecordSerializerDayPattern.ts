...
- legal_holiday: 法定休日
 */
export type ApiV1EmployeesWorkRecordSerializerDayPattern = typeof ApiV1EmployeesWorkRecordSerializerDayPattern[keyof typeof ApiV1EmployeesWorkRecordSerializerDayPattern];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1EmployeesWorkRecordSerializerDayPattern = {
