 ...
 */
import type { ApiV1EmployeesWorkRecordSerializerPaidHolidaysItemType } from './apiV1EmployeesWorkRecordSerializerPaidHolidaysItemType';

export type ApiV1EmployeesWorkRecordSerializerPaidHolidaysItem = {
  /**
   * 有給休暇の種別取得単位（full:全休、half:半休、morning_off:午前休、 afternoon_off:午後休、hourly:時間休）
   */
  type: ApiV1EmployeesWorkRecordSerializerPaidHolidaysItemType;
  /** 年次有給休暇の休暇時間（分単位） */
  mins: number;
