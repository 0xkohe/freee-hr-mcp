 ...
 */
import type { ApiV1HolidaysAndHoursSerializer } from './apiV1HolidaysAndHoursSerializer';
import type { ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer } from './apiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer';
import type { ApiV1EmployeesWorkRecordSummarySerializerWorkRecordsItem } from './apiV1EmployeesWorkRecordSummarySerializerWorkRecordsItem';
...
export interface ApiV1EmployeesWorkRecordSummarySerializer {
  ...
  multi_hourly_wages?: ApiV1EmployeesEmployeeMultiHourlyWageWorkRecordSummarySerializer[];
  /** 日々の勤怠情報 */
  work_records?: ApiV1EmployeesWorkRecordSummarySerializerWorkRecordsItem[];
  /**
   * 不足時間（分）
   * @nullable
   */
