...
import type { ApiV1EmployeesWorkRecordsControllerUpdateBodyDayPattern } from './apiV1EmployeesWorkRecordsControllerUpdateBodyDayPattern';
import type { ApiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItem } from './apiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItem';
import type { ApiV1EmployeesWorkRecordsControllerUpdateBodySpecialHoliday } from './apiV1EmployeesWorkRecordsControllerUpdateBodySpecialHoliday';
...
- lateness_mins
- paid_holiday */
  day_pattern?: ApiV1EmployeesWorkRecordsControllerUpdateBodyDayPattern;
  /**
   * 早退分の時間（分単位）
   * @minimum 0
   * @maximum 1440
...
- hourly_special_holiday_mins */
   ...
   */
  note?: string;
  paid_holidays?: ApiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItem[];
  /** この日の特別休暇取得日数。1日単位で指定します。 */
  special_holiday?: ApiV1EmployeesWorkRecordsControllerUpdateBodySpecialHoliday;
  /**
   * 特別休暇設定ID
   * @minimum 1
   * @maximum 2147483647
