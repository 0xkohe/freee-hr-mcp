 ...
 */
import type { ApiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItemType } from './apiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItemType';

export type ApiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItem = {
  /**
   * 有給休暇の種別を指定します（全休：full, 半休：half, 午前休：morning_off, 午後休：afternoon_off, 時間休：hourly）
   */
  type: ApiV1EmployeesWorkRecordsControllerUpdateBodyPaidHolidaysItemType;
  /**
