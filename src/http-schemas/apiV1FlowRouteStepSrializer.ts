 ...
 */
import type { ApiV1FlowRouteStepSrializerItem } from './apiV1FlowRouteStepSrializerItem';

/**
 * 承認ステップ（配列）
 */
export type ApiV1FlowRouteStepSrializer = ApiV1FlowRouteStepSrializerItem[];
