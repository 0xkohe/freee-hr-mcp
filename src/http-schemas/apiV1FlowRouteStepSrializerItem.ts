 ...
 */
import type { ApiV1FlowRouteStepSrializerItemResourceType } from './apiV1FlowRouteStepSrializerItemResourceType';

export type ApiV1FlowRouteStepSrializerItem = {
  /**
   * 承認ステップID
   * @minimum 1
   * @maximum 2147483647
  ...
  resource_type: ApiV1FlowRouteStepSrializerItemResourceType;
  /** 承認者のユーザーID (配列) */
  user_ids?: number[];
};
