 ...
 */
import type { ApiV1MonthlyAttendanceIndexResponseParams } from './apiV1MonthlyAttendanceIndexResponseParams';

export interface ApiV1MonthlyAttendanceIndexResponse {
  monthly_attendances: ApiV1MonthlyAttendanceIndexResponseParams[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
