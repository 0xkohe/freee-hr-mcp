 ...
 */
import type { ApiV1MonthlyAttendanceIndexResponseParamsStatus } from './apiV1MonthlyAttendanceIndexResponseParamsStatus';

export interface ApiV1MonthlyAttendanceIndexResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  status: ApiV1MonthlyAttendanceIndexResponseParamsStatus;
  /** 自動チェック結果 */
