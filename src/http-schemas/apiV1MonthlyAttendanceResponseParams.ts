 ...
 */
import type { ApiV1MonthlyAttendanceResponseParamsStatus } from './apiV1MonthlyAttendanceResponseParamsStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export interface ApiV1MonthlyAttendanceResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  status: ApiV1MonthlyAttendanceResponseParamsStatus;
  /** 自動チェック結果 */
