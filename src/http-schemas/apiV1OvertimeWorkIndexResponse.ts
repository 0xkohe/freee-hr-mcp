 ...
 */
import type { ApiV1OvertimeWorkIndexResponseParams } from './apiV1OvertimeWorkIndexResponseParams';

export interface ApiV1OvertimeWorkIndexResponse {
  overtime_works: ApiV1OvertimeWorkIndexResponseParams[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
