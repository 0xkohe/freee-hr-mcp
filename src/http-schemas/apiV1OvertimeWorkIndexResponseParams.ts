 ...
 */
import type { ApiV1OvertimeWorkIndexResponseParamsStatus } from './apiV1OvertimeWorkIndexResponseParamsStatus';
import type { ApiV1OvertimeWorkIndexResponseParamsRevokeStatus } from './apiV1OvertimeWorkIndexResponseParamsRevokeStatus';

export interface ApiV1OvertimeWorkIndexResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  status: ApiV1OvertimeWorkIndexResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1OvertimeWorkIndexResponseParamsRevokeStatus;
  /** 自動チェック結果 */
