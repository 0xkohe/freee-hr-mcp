 ...
 * @nullable
 */
export type ApiV1OvertimeWorkIndexResponseParamsRevokeStatus = typeof ApiV1OvertimeWorkIndexResponseParamsRevokeStatus[keyof typeof ApiV1OvertimeWorkIndexResponseParamsRevokeStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1OvertimeWorkIndexResponseParamsRevokeStatus = {
  revoking: 'revoking',
  revoked: 'revoked',
} as const;
