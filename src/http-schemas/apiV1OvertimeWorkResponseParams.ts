 ...
 */
import type { ApiV1OvertimeWorkResponseParamsStatus } from './apiV1OvertimeWorkResponseParamsStatus';
import type { ApiV1OvertimeWorkResponseParamsRevokeStatus } from './apiV1OvertimeWorkResponseParamsRevokeStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export interface ApiV1OvertimeWorkResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  status: ApiV1OvertimeWorkResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1OvertimeWorkResponseParamsRevokeStatus;
  /** 自動チェック結果 */
