 ...
 * @nullable
 */
export type ApiV1OvertimeWorkResponseParamsRevokeStatus = typeof ApiV1OvertimeWorkResponseParamsRevokeStatus[keyof typeof ApiV1OvertimeWorkResponseParamsRevokeStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1OvertimeWorkResponseParamsRevokeStatus = {
  revoking: 'revoking',
  revoked: 'revoked',
} as const;
