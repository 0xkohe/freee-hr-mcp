 ...
 */
import type { ApiV1PaidHolidayIndexResponsePaidHolidaysItem } from './apiV1PaidHolidayIndexResponsePaidHolidaysItem';

export interface ApiV1PaidHolidayIndexResponse {
  paid_holidays: ApiV1PaidHolidayIndexResponsePaidHolidaysItem[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
