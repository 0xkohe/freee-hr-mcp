 ...
 */
import type { ApiV1PaidHolidayIndexResponseParamsValuesItem } from './apiV1PaidHolidayIndexResponseParamsValuesItem';
import type { ApiV1PaidHolidayIndexResponseParamsStatus } from './apiV1PaidHolidayIndexResponseParamsStatus';
import type { ApiV1PaidHolidayIndexResponseParamsRevokeStatus } from './apiV1PaidHolidayIndexResponseParamsRevokeStatus';

export interface ApiV1PaidHolidayIndexResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
   ...
   */
  target_date: string;
  values: ApiV1PaidHolidayIndexResponseParamsValuesItem[];
  /**
   * 申請日
   * @pattern ^[0-9]{4}-[0-9]{2}-[0-9]{2}$
   */
  ...
  status: ApiV1PaidHolidayIndexResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1PaidHolidayIndexResponseParamsRevokeStatus;
  /** 自動チェック結果 */
