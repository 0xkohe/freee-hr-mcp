 ...
 * @nullable
 */
export type ApiV1PaidHolidayIndexResponseParamsRevokeStatus = typeof ApiV1PaidHolidayIndexResponseParamsRevokeStatus[keyof typeof ApiV1PaidHolidayIndexResponseParamsRevokeStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1PaidHolidayIndexResponseParamsRevokeStatus = {
  revoking: 'revoking',
  revoked: 'revoked',
} as const;
