 ...
 */
import type { ApiV1PaidHolidayIndexResponseParamsValuesItemType } from './apiV1PaidHolidayIndexResponseParamsValuesItemType';

export type ApiV1PaidHolidayIndexResponseParamsValuesItem = {
  /**
   * 取得単位。（full:全休、half:半休、morning:午前休、 afternoon:午後休、hourly:時間休）
   */
  type: ApiV1PaidHolidayIndexResponseParamsValuesItemType;
  /**
   * 取得予定開始時間
   * @nullable
