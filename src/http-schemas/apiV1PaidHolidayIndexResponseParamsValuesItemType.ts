 ...
 */
export type ApiV1PaidHolidayIndexResponseParamsValuesItemType = typeof ApiV1PaidHolidayIndexResponseParamsValuesItemType[keyof typeof ApiV1PaidHolidayIndexResponseParamsValuesItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1PaidHolidayIndexResponseParamsValuesItemType = {
  full: 'full',
  half: 'half',
  morning: 'morning',
  afternoon: 'afternoon',
