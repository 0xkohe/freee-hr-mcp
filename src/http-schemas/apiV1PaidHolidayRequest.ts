 ...
 */
import type { ApiV1PaidHolidayRequestValuesItem } from './apiV1PaidHolidayRequestValuesItem';

export interface ApiV1PaidHolidayRequest {
  /**
   * 事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
   ...
   */
  target_date: string;
  values: ApiV1PaidHolidayRequestValuesItem[];
  /**
   * 申請理由
   * @maxLength 255
   */
