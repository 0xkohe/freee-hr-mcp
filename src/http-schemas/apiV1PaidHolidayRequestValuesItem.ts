 ...
 */
import type { ApiV1PaidHolidayRequestValuesItemType } from './apiV1PaidHolidayRequestValuesItemType';

export type ApiV1PaidHolidayRequestValuesItem = {
  /**
   * 取得単位。（full:全休、half:半休、morning:午前休、 afternoon:午後休、hourly:時間休）
   */
  type: ApiV1PaidHolidayRequestValuesItemType;
  /**
