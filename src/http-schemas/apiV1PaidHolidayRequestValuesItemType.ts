 ...
 */
export type ApiV1PaidHolidayRequestValuesItemType = typeof ApiV1PaidHolidayRequestValuesItemType[keyof typeof ApiV1PaidHolidayRequestValuesItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1PaidHolidayRequestValuesItemType = {
  full: 'full',
  half: 'half',
  morning: 'morning',
  afternoon: 'afternoon',
