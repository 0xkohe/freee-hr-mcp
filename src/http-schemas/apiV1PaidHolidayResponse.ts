 ...
 */
import type { ApiV1PaidHolidayResponsePaidHoliday } from './apiV1PaidHolidayResponsePaidHoliday';

export interface ApiV1PaidHolidayResponse {
  paid_holiday: ApiV1PaidHolidayResponsePaidHoliday;
}
