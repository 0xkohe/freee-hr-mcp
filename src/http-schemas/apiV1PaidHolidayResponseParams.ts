 ...
 */
import type { ApiV1PaidHolidayResponseParamsValuesItem } from './apiV1PaidHolidayResponseParamsValuesItem';
import type { ApiV1PaidHolidayResponseParamsStatus } from './apiV1PaidHolidayResponseParamsStatus';
import type { ApiV1PaidHolidayResponseParamsRevokeStatus } from './apiV1PaidHolidayResponseParamsRevokeStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export interface ApiV1PaidHolidayResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
   ...
   */
  target_date: string;
  values: ApiV1PaidHolidayResponseParamsValuesItem[];
  /**
   * 申請日
   * @pattern ^[0-9]{4}-[0-9]{2}-[0-9]{2}$
   */
  ...
  status: ApiV1PaidHolidayResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1PaidHolidayResponseParamsRevokeStatus;
  /** 自動チェック結果 */
