 ...
 * @nullable
 */
export type ApiV1PaidHolidayResponseParamsRevokeStatus = typeof ApiV1PaidHolidayResponseParamsRevokeStatus[keyof typeof ApiV1PaidHolidayResponseParamsRevokeStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1PaidHolidayResponseParamsRevokeStatus = {
  revoking: 'revoking',
  revoked: 'revoked',
} as const;
