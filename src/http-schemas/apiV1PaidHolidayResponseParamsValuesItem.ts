 ...
 */
import type { ApiV1PaidHolidayResponseParamsValuesItemType } from './apiV1PaidHolidayResponseParamsValuesItemType';

export type ApiV1PaidHolidayResponseParamsValuesItem = {
  /**
   * 取得単位。（full:全休、half:半休、morning:午前休、 afternoon:午後休、hourly:時間休）
   */
  type: ApiV1PaidHolidayResponseParamsValuesItemType;
  /**
   * 取得予定開始時間
   * @nullable
