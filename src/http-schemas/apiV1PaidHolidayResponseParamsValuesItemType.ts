 ...
 */
export type ApiV1PaidHolidayResponseParamsValuesItemType = typeof ApiV1PaidHolidayResponseParamsValuesItemType[keyof typeof ApiV1PaidHolidayResponseParamsValuesItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1PaidHolidayResponseParamsValuesItemType = {
  full: 'full',
  half: 'half',
  morning: 'morning',
  afternoon: 'afternoon',
