 ...
 */
import type { ApiV1EmployeeProfileCustomFieldSerializer } from './apiV1EmployeeProfileCustomFieldSerializer';

export interface ApiV1ProfileCustomFieldGroupSerializer {
  /** グループID */
  id?: number;
  /** グループ名 */
  name?: string;
  /** カスタム項目 */
  profile_custom_field_rules?: ApiV1EmployeeProfileCustomFieldSerializer[];
}
