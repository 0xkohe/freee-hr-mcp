 ...
 */
export type ApiV1SalariesEmployeePayrollStatementSerializerPayCalcType = typeof ApiV1SalariesEmployeePayrollStatementSerializerPayCalcType[keyof typeof ApiV1SalariesEmployeePayrollStatementSerializerPayCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1SalariesEmployeePayrollStatementSerializerPayCalcType = {
  monthly: 'monthly',
  daily: 'daily',
  hourly: 'hourly',
  '': '',
