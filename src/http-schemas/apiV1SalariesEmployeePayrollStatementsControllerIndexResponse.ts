 ...
 */
import type { ApiV1SalariesEmployeePayrollStatementSerializer } from './apiV1SalariesEmployeePayrollStatementSerializer';

export interface ApiV1SalariesEmployeePayrollStatementsControllerIndexResponse {
  employee_payroll_statements?: ApiV1SalariesEmployeePayrollStatementSerializer[];
  /**
