 ...
 */
import type { ApiV1WorkTimeIndexResponseParamsWorkRecordsItem } from './apiV1WorkTimeIndexResponseParamsWorkRecordsItem';
import type { ApiV1WorkTimeIndexResponseParamsBreakRecordsItem } from './apiV1WorkTimeIndexResponseParamsBreakRecordsItem';
import type { ApiV1WorkTimeIndexResponseParamsStatus } from './apiV1WorkTimeIndexResponseParamsStatus';

export interface ApiV1WorkTimeIndexResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  work_records?: ApiV1WorkTimeIndexResponseParamsWorkRecordsItem[];
  /** 遅刻分の時間（分単位） */
  lateness_mins: number;
  /** 早退分の時間（分単位） */
  early_leaving_mins: number;
  /** 休憩時間のリスト */
  break_records?: ApiV1WorkTimeIndexResponseParamsBreakRecordsItem[];
  /**
   * 申請日
   * @pattern ^[0-9]{4}-[0-9]{2}-[0-9]{2}$
   */
  ...
  status: ApiV1WorkTimeIndexResponseParamsStatus;
  /** 自動チェック結果 */
