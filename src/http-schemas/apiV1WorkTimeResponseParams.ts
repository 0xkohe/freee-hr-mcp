...
import type { ApiV1WorkTimeResponseParamsStatus } from './apiV1WorkTimeResponseParamsStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export interface ApiV1WorkTimeResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  status: ApiV1WorkTimeResponseParamsStatus;
  /** 自動チェック結果 */
