 ...
 */
import type { ApiV1specialHolidayIndexResponseSpecialHolidaysItem } from './apiV1specialHolidayIndexResponseSpecialHolidaysItem';

export interface ApiV1specialHolidayIndexResponse {
  special_holidays: ApiV1specialHolidayIndexResponseSpecialHolidaysItem[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
