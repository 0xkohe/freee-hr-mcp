 ...
 */
import type { ApiV1specialHolidayIndexResponseSpecialHolidaysItemHolidayType } from './apiV1specialHolidayIndexResponseSpecialHolidaysItemHolidayType';
import type { ApiV1specialHolidayIndexResponseSpecialHolidaysItemStatus } from './apiV1specialHolidayIndexResponseSpecialHolidaysItemStatus';
import type { ApiV1specialHolidayIndexResponseSpecialHolidaysItemRevokeStatus } from './apiV1specialHolidayIndexResponseSpecialHolidaysItemRevokeStatus';

export type ApiV1specialHolidayIndexResponseSpecialHolidaysItem = {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  holiday_type: ApiV1specialHolidayIndexResponseSpecialHolidaysItemHolidayType;
  /**
   * 取得予定開始時間
   * @nullable
  ...
  status: ApiV1specialHolidayIndexResponseSpecialHolidaysItemStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1specialHolidayIndexResponseSpecialHolidaysItemRevokeStatus;
  /** 自動チェック結果 */
