 ...
 */
import type { ApiV1specialHolidayRequestHolidayType } from './apiV1specialHolidayRequestHolidayType';

export interface ApiV1specialHolidayRequest {
  /**
   * 事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
  ...
  holiday_type: ApiV1specialHolidayRequestHolidayType;
  /**
   * 取得予定開始時間（条件付き必須）
取得単位が半休、時間休の場合は必須
   * @pattern ^[0-9]{2}:[0-9]{2}?$
