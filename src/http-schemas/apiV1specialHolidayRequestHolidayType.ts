 ...
 */
export type ApiV1specialHolidayRequestHolidayType = typeof ApiV1specialHolidayRequestHolidayType[keyof typeof ApiV1specialHolidayRequestHolidayType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1specialHolidayRequestHolidayType = {
  full: 'full',
  half: 'half',
  morning: 'morning',
  afternoon: 'afternoon',
