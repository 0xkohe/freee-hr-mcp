 ...
 */
import type { ApiV1specialHolidayResponseSpecialHoliday } from './apiV1specialHolidayResponseSpecialHoliday';

export interface ApiV1specialHolidayResponse {
  special_holiday: ApiV1specialHolidayResponseSpecialHoliday;
}
