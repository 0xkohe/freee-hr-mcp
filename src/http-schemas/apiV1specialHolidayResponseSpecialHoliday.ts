 ...
 */
import type { ApiV1specialHolidayResponseSpecialHolidayHolidayType } from './apiV1specialHolidayResponseSpecialHolidayHolidayType';
import type { ApiV1specialHolidayResponseSpecialHolidayStatus } from './apiV1specialHolidayResponseSpecialHolidayStatus';
import type { ApiV1specialHolidayResponseSpecialHolidayRevokeStatus } from './apiV1specialHolidayResponseSpecialHolidayRevokeStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export type ApiV1specialHolidayResponseSpecialHoliday = {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  holiday_type: ApiV1specialHolidayResponseSpecialHolidayHolidayType;
  /**
   * 取得予定開始時間
   * @nullable
  ...
  status: ApiV1specialHolidayResponseSpecialHolidayStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: ApiV1specialHolidayResponseSpecialHolidayRevokeStatus;
  /** 自動チェック結果 */
  ...
  /** 承認履歴 */
  approval_flow_logs: ApiV1ApprovalFlowLogsParams[];
  /**
   * 現在承認ステップID<br>
申請を差戻した場合、nullになります。
   * @minimum 1
