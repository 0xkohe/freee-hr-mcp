 ...
 */
export type ApiV1specialHolidayResponseSpecialHolidayHolidayType = typeof ApiV1specialHolidayResponseSpecialHolidayHolidayType[keyof typeof ApiV1specialHolidayResponseSpecialHolidayHolidayType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1specialHolidayResponseSpecialHolidayHolidayType = {
  full: 'full',
  half: 'half',
  morning: 'morning',
  afternoon: 'afternoon',
