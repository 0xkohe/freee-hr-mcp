 ...
 * @nullable
 */
export type ApiV1specialHolidayResponseSpecialHolidayRevokeStatus = typeof ApiV1specialHolidayResponseSpecialHolidayRevokeStatus[keyof typeof ApiV1specialHolidayResponseSpecialHolidayRevokeStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApiV1specialHolidayResponseSpecialHolidayRevokeStatus = {
  revoking: 'revoking',
  revoked: 'revoked',
} as const;
