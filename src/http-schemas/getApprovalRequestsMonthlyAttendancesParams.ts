 ...
 */
import type { GetApprovalRequestsMonthlyAttendancesStatus } from './getApprovalRequestsMonthlyAttendancesStatus';

export type GetApprovalRequestsMonthlyAttendancesParams = {
/**
 * 事業所ID
 * @minimum 1
 * @maximum 2147483647
...
- `feedback` - 差戻し
 */
status?: GetApprovalRequestsMonthlyAttendancesStatus;
/**
 * 申請No
 * @minimum 1
 * @maximum 2147483647
