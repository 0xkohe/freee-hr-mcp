 ...
 */
import type { GetApprovalRequestsOvertimeWorksStatus } from './getApprovalRequestsOvertimeWorksStatus';

export type GetApprovalRequestsOvertimeWorksParams = {
/**
 * 事業所ID
 * @minimum 1
 * @maximum 2147483647
...
- `feedback` - 差戻し
 */
status?: GetApprovalRequestsOvertimeWorksStatus;
/**
 * 申請No
 * @minimum 1
 * @maximum 2147483647
