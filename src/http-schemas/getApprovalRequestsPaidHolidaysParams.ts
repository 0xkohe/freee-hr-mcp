 ...
 */
import type { GetApprovalRequestsPaidHolidaysStatus } from './getApprovalRequestsPaidHolidaysStatus';

export type GetApprovalRequestsPaidHolidaysParams = {
/**
 * 事業所ID
 * @minimum 1
 * @maximum 2147483647
...
- `feedback` - 差戻し
 */
status?: GetApprovalRequestsPaidHolidaysStatus;
/**
 * 申請No
 * @minimum 1
 * @maximum 2147483647
