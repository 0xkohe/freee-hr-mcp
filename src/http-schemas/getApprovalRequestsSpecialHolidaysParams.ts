 ...
 */
import type { GetApprovalRequestsSpecialHolidaysStatus } from './getApprovalRequestsSpecialHolidaysStatus';

export type GetApprovalRequestsSpecialHolidaysParams = {
/**
 * 事業所ID
 * @minimum 1
 * @maximum 2147483647
...
- `feedback` - 差戻し
 */
status?: GetApprovalRequestsSpecialHolidaysStatus;
/**
 * 申請No
 * @minimum 1
 * @maximum 2147483647
