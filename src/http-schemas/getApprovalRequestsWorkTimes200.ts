 ...
 */
import type { ApiV1WorkTimeIndexResponseParams } from './apiV1WorkTimeIndexResponseParams';

export type GetApprovalRequestsWorkTimes200 = {
  work_times: ApiV1WorkTimeIndexResponseParams[];
  /**
   * 合計件数
   * @minimum 0
   * @maximum 2147483647
