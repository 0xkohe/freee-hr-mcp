 ...
 */
import type { GetApprovalRequestsWorkTimesStatus } from './getApprovalRequestsWorkTimesStatus';

export type GetApprovalRequestsWorkTimesParams = {
/**
 * 事業所ID
 * @minimum 1
 * @maximum 2147483647
...
- `feedback` - 差戻し
 */
status?: GetApprovalRequestsWorkTimesStatus;
/**
 * 申請No
 * @minimum 1
 * @maximum 2147483647
