 ...
 */
export type GetEmployeesSpecialHolidays200EmployeeSpecialHolidaysItemAttendanceRateCalcType = typeof GetEmployeesSpecialHolidays200EmployeeSpecialHolidaysItemAttendanceRateCalcType[keyof typeof GetEmployeesSpecialHolidays200EmployeeSpecialHolidaysItemAttendanceRateCalcType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetEmployeesSpecialHolidays200EmployeeSpecialHolidaysItemAttendanceRateCalcType = {
  in_workdays: 'in_workdays',
  not_in_workdays: 'not_in_workdays',
  not_in_total_workdays: 'not_in_total_workdays',
} as const;
