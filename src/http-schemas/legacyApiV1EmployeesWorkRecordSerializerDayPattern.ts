...
- legal_holiday: 法定休日
 */
export type LegacyApiV1EmployeesWorkRecordSerializerDayPattern = typeof LegacyApiV1EmployeesWorkRecordSerializerDayPattern[keyof typeof LegacyApiV1EmployeesWorkRecordSerializerDayPattern];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const LegacyApiV1EmployeesWorkRecordSerializerDayPattern = {
