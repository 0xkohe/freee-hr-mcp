 ...
 */
export type LegacyApiV1EmployeesWorkRecordSerializerSchedulePattern = typeof LegacyApiV1EmployeesWorkRecordSerializerSchedulePattern[keyof typeof LegacyApiV1EmployeesWorkRecordSerializerSchedulePattern];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const LegacyApiV1EmployeesWorkRecordSerializerSchedulePattern = {
  '': '',
  substitute_holiday_work: 'substitute_holiday_work',
  substitute_holiday: 'substitute_holiday',
  compensatory_holiday_work: 'compensatory_holiday_work',
