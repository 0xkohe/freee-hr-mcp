 ...
 */
import type { LegacyApiV1PaidHolidayIndexResponseParamsHolidayType } from './legacyApiV1PaidHolidayIndexResponseParamsHolidayType';
import type { LegacyApiV1PaidHolidayIndexResponseParamsStatus } from './legacyApiV1PaidHolidayIndexResponseParamsStatus';
import type { LegacyApiV1PaidHolidayIndexResponseParamsRevokeStatus } from './legacyApiV1PaidHolidayIndexResponseParamsRevokeStatus';

export interface LegacyApiV1PaidHolidayIndexResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  holiday_type: LegacyApiV1PaidHolidayIndexResponseParamsHolidayType;
  /**
  ...
  status: LegacyApiV1PaidHolidayIndexResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: LegacyApiV1PaidHolidayIndexResponseParamsRevokeStatus;
  /** 自動チェック結果 */
