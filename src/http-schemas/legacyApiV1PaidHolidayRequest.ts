 ...
 */
import type { LegacyApiV1PaidHolidayRequestHolidayType } from './legacyApiV1PaidHolidayRequestHolidayType';

export interface LegacyApiV1PaidHolidayRequest {
  /**
   * 事業所ID（必須）
   * @minimum 1
   * @maximum 2147483647
  ...
  holiday_type: LegacyApiV1PaidHolidayRequestHolidayType;
  /**
