 ...
 */
import type { LegacyApiV1PaidHolidayResponseParamsHolidayType } from './legacyApiV1PaidHolidayResponseParamsHolidayType';
import type { LegacyApiV1PaidHolidayResponseParamsStatus } from './legacyApiV1PaidHolidayResponseParamsStatus';
import type { LegacyApiV1PaidHolidayResponseParamsRevokeStatus } from './legacyApiV1PaidHolidayResponseParamsRevokeStatus';
import type { ApiV1ApprovalFlowLogsParams } from './apiV1ApprovalFlowLogsParams';

export interface LegacyApiV1PaidHolidayResponseParams {
  /**
   * 申請ID
   * @minimum 1
   * @maximum 2147483647
...
- 申請が差戻された */
  ...
  holiday_type: LegacyApiV1PaidHolidayResponseParamsHolidayType;
  /**
  ...
  status: LegacyApiV1PaidHolidayResponseParamsStatus;
  /**
   * 取消申請ステータス。（null:取消申請されてない、revoking:取消中、revoked:取消済）
   * @nullable
   */
  revoke_status: LegacyApiV1PaidHolidayResponseParamsRevokeStatus;
  /** 自動チェック結果 */
